...
we are using [Mapbox](https://www.mapbox.com/) in our app to show [static image](https://docs.mapbox.com/api/maps/static-images/) of the location in location based query response. Sign up for an account [here](https://docs.mapbox.com/api/overview/) and create an access token [here](https://account.mapbox.com/) and save it in local to use it later.
